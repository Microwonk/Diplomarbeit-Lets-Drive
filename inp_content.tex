...
Es muss immer ein Produkt konstruiert werden welches die Anforderungen des Kunden und nicht die der Firma erfüllt. In unserem Fall sind die eigentlichen Kunden die User. Dazu dient das Lasten und das Pflichtenheft. In diesen Pflichtenheft werden alle Muss Anforderungen beschrieben, die an diese Software gestellt werde. Weiters werden die Kann Anforderungen beschrieben, die auch vom Kunden kommen. In den Nicht Zielen wird nochmals auf ein paar wichtige Punkte eingegangen für die diese App nicht gedacht ist.
...
eine Datenbank zur Verfügung. Auch ein manuellen Hinzufügen einer Fahrt soll möglich sein.
...
\subsection{Produkteinsatz und Umgebung}
	...
	Das Produkt wird eine Cross-Platform App, welche auf den Betriebssystemen Android und iOS erhältlich sein wird. Let's Drive findet Anwendung bei Fahrschülern/Fahrschülerinnen, welche die L-Tafel oder den L-17 Fahrschein absolvieren wollen. Dienste der App beinhalten z.B. Tracking, Statistik der Fahrten, einfacher Export der Tracking Daten in das Formular für den Fahrschein mit 3000 bzw. 1000 Kilometer. Ein GPS wird für das Tracking benötigt. Eine Internetverbindung ist während einer Fahrt nicht erfordelich. 
	Zielplattformen sind iOS und Android da diese die üblichen Betriebssysteme sind. 
	Eine Erweiterung ist mit der gewählten Technologie möglich.
...
Unit Tests sind der erste Schritt, danach werden Integrationstests durchgeführt. Nach proof of concept und Abdeckung der meisten Testfälle werden eigenständige Alpha-Tests innerhalb des Entwicklungs-Teams durchgeführt. Dies beinhaltet einen Dev-Account, das Aufzeichnen von Fahrten und der Upload auf die Datenbank. Danach sollen Beta-Tester (Bekannte und Freiwillige) die App testen, indem wir sie für Beta-Tester auf den App-Stores zu Verfügung stellen.

\emph{Testfälle}
\begin{itemize}
	\item Fahrt starten und aufnehmen
	\item Fahrt auf die Datenbank hochladen / auf den lokalen Speicher legen
...
Bereitstellung der App im Apple App-Store, im Google Play Store (und eventuell in der Huawei App-Gallery), damit die App an alle österreichischen Fahrschüler:innen bereitgestellt werden kann.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figures/Ablaufdiagramm1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=11cm]{figures/Ablaufdiagramm2.png}
	\caption{Ablaufdiagramm GPS}
