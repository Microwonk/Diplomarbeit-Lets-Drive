...
Die rasante Entwicklung digitaler Anwendungen, insbesondere mobiler Apps, geht mit vielfältigen Risiken einher, die die Sicherheit und Funktionalität beeinträchtigen können. Dieser Abschnitt widmet sich der umfassenden Risikoanalyse von der Let's Drive App, um potenzielle Gefahren zu identifizieren, zu bewerten und geeignete Maßnahmen zur Risikominderung zu erarbeiten. Diese werden anfolgend mittels einer Risikomatrix (Abbildung \ref{fig:Risikomatrix}) und Tabellen (Identifizierung in Tabelle \ref{tab:Identifizierung}, und Einstufung in Tabellen \ref{tab:Risokoeinstufung} \& \ref{tab:Legende}) erörtert und beschrieben.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3cm}|p{2cm}|p{2.5cm}|X|}
		...
		\hline
		Apps der Konkurrenz & W & weniger User & Features verbessern, neue Features \\
		\hline
		App wird nicht gut angenommen & P, W & weniger User & Marketing, bessere Features \\
		\hline
		Tracking für Schüler wird nicht erlaubt & R & Feature fällt weg & Begleitperson übernimmt dieses Feature vollständig \\
		\hline
		App ist wirtschaftlich uninteressant & W & geringe Einnahmen & keine, oder Werbung einbauen. Das ist kein Ziel der Projektgruppe \\
		\hline
		Nicht sofort auf allen Plattformen verfügbar & T & Plattform fehlt zu Beginn & Da ein MAC erforderlich ist, diesen Teil der Partnerfirma abgeben \\
		\hline
		Maui ist ganz neu und wird nicht angenommen & T & kann eine gute oder schlechte Wahl sein & keine  \\
		\hline
	\end{tabularx}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|c|c|c|}
		\hline
		\textbf{Risiko} & \textbf{Eintritts-wahrsch.} & \textbf{Auswirkung} & \textbf{Risiko-potential} \\
		\hline
		Konkurrenz ist besser & 2 & 4 & 8 \\
		\hline
		App wird nicht angenommen & 2 & 4 & 8 \\
		\hline
		Tracking für Schüler wird nicht erlaubt & 1 & 2 & 2 \\
		\hline
		App ist finanziell uninteressant & 2 & 1 & 2 \\
		\hline
		Deployment für alle Plattformen & 2 & 2 & 4 \\
		\hline
		Maui ist ganz neu und wird nicht angenommen & 2 & 2 & 4  \\
		\hline
 	\end{tabularx}
	\caption{Risikoeinstufung}
	\label{tab:Risokoeinstufung}	
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
		1 & gering 		& gering 		& 1 x 1 = 1 \\
		\hline
		2 & mittel 		& mittel 		& 2 x 2 =  4 \\
		\hline
		3 & hoch   		& hoch 			& 3 x 3 = 9  \\
		\hline
		4 & hoch 	& sehr hoch		& 4 x 4 = 16 \\
		\hline
		4 & sehr hoch 	& katastrophal		& 4 x 4 = 16 \\
		\hline
	\end{tabular}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=15cm]{figures/placeholder.png} %TODO grafik einblenden und beschreiben
