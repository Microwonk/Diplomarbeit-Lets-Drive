...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3cm}|p{2cm}|p{2.5cm}|X|}
		...
		\hline
		Konkurrenz ist besser & W & weniger User & Features verbessern, neue Features \\
		\hline
		App wird nicht angenommen & P, W & weniger User & Marketing, bessere Features \\
		\hline
		Tracking für Schüler wird nicht erlaubt & R & Feature fällt weg & Begleitperson übernimmt dieses Feature vollständig \\
		\hline
		App ist finanziell uninteressant & W & geringe Einnahmen & keine oder Werbung einbauen. Das ist kein Ziel der Projektgruppe \\
		\hline
		Deployment für alle Plattformen & T & Plattform fehlt zu Beginn & Da ein MAC erforderlich ist, diesen Teil der Partnerfirma abgeben \\
		\hline
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		3 & hoch   		& hoch 			& 3 x 3 = 9  \\
		\hline
		4 & sehr hoch 	& sehr hoch		& 4 x 4 = 16 \\
		\hline
	\end{tabular}
