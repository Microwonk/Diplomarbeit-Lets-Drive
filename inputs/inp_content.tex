...
.NET Maui baut auf folgenden Schichtenmodell auf.

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/MauiSchichtenmodell.png}
	\caption{Ablaufplan Let's Drive}
	\label{fig:Maui Schichtenmodell}
\end{figure}
