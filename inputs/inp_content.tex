...
Hier wird nun auf die Architektur und die Struktur des Codes eingegangen mit dem die App aufgebaut wurde. Bei der Programmierung ist es sehr wichtig grundsätzliche Designprinzipien einzuhalten um die App Leserlich und Komponenten austauschbar zu halten.
\section{Softwarearchitektur}

Bei einfachen Maui Apps kann man mit Code behind arbeiten. Das ist einfach gesagt eine Vererbung des XAML Content in eine darunterliegende C\# Datei. So hat man direkten Zugriff auf Variablen im XAML User Interface. Da das Model View View-Model Pattern kurz MVVM für umfangreichere Maui Apps der Standard ist haben wir uns von Beginn an für dieses Design-Pattern entschieden. Hier ist das User Interface (View) der Code welcher dieses manipuliert (View-Model) und die reine Programmlogik (Model) in getrennten Dateien (Namespaces).
