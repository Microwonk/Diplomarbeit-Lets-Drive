...
Die Entwicklung digitaler Anwendungen, insbesondere mobiler Apps, geht mit vielfältigen Risiken einher, die Sicherheit und Funktionalität beeinträchtigen können. Aber auch externe Einflüsse können ein Projekt gefährden. Dieser Abschnitt widmet sich der umfassenden Risikoanalyse von Let's Drive, um potenzielle Gefahren zu identifizieren, zu bewerten und geeignete Maßnahmen zur Risikominderung zu erarbeiten. Diese werden mittels einer Risikomatrix (Abbildung \ref{fig:Risikomatrix}) und Tabellen (Identifizierung in Tabelle \ref{tab:Identifizierung}, und Einstufung in Tabellen \ref{tab:Risokoeinstufung} \& \ref{tab:Legende}) erörtert und beschrieben.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3cm}|p{2cm}|p{2.5cm}|X|}
		...
		\hline
		App ist wirtschaftlich uninteressant & W & geringe Einnahmen & Werbung einbauen. Das ist kein Hauptziel Ziel der Projektgruppe \\
		\hline
		Das Deployment für alle Plattformen ist von beginn an nicht möglich & T & Plattform fehlt zu Beginn & Da ein MAC erforderlich ist, diesen Teil der Partnerfirma abgeben \\
		\hline
		Maui ist ein neues Framework und ist nicht in jedem Bereich gleich gut wie andere oder native programmierte Apps & T & kann eine gute oder schlechte Wahl sein & keine  \\
		\hline
	\end{tabularx}
