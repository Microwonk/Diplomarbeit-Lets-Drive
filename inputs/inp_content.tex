...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{3cm}|p{2cm}|p{2.5cm}|X|}
		...
		\hline
		Konkurrenz ist besser & W, T & weniger User & vorhandene Features verbessern, neue Features hinzufügen die User anlocken \\
		\hline
		App wird nicht gut angenommen & P, W & weniger User & mehr Marketing, bessere Features erstellen \\
		\hline
		...
		\hline
		Das Deployment für alle Plattformen ist von beginn an nicht möglich & W & Plattform fehlt zu Beginn & Da ein neuer MAC für die Kompilierung erforderlich ist sollten wir diesen Teil der Partnerfirma abgeben \\
		\hline
		Maui ist ein ganz neues Framework und nicht in jedem Bereich gleich gut wie andere oder native programmierte Apps & T & kann eine gute oder schlechte Wahl sein & keine  \\
		\hline
	\end{tabularx}
